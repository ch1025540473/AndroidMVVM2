package com.mx.engine.widget.simplifyspan.unit;


import com.mx.engine.widget.simplifyspan.other.OnClickableSpanListener;
import com.mx.engine.widget.simplifyspan.other.SpecialConvertModeEnum;
import com.mx.engine.widget.simplifyspan.other.SpecialGravityEnum;
...
public class SpecialTextUnit extends BaseSpecialUnit {
    ...
    public SpecialTextUnit setOnClickListener(boolean isShowClickableSpanUnderline, OnClickableSpanListener onClickListener) {
        return setOnClickListener(isShowClickableSpanUnderline, 0, onClickListener, id);
    }
     ...
     */
    public SpecialTextUnit setOnClickListener(boolean isShowClickableSpanUnderline, int clickableSpanPreBgColor, OnClickableSpanListener onClickListener, String id) {
        return setOnClickListener(isShowClickableSpanUnderline, clickableSpanPreBgColor, 0, onClickListener, id);
    }
     ...
     * @return SpecialTextUnit
     */
    public SpecialTextUnit setOnClickListener(boolean isShowClickableSpanUnderline, int clickableSpanPreBgColor, int mClickableSpanPreTextColor, OnClickableSpanListener onClickListener, String id) {
