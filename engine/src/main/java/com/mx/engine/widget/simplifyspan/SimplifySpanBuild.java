package com.mx.engine.widget.simplifyspan;
...
import com.mx.engine.widget.simplifyspan.customspan.CustomAbsoluteSizeSpan;
import com.mx.engine.widget.simplifyspan.customspan.CustomClickableSpan;
import com.mx.engine.widget.simplifyspan.customspan.CustomImageSpan;
import com.mx.engine.widget.simplifyspan.customspan.CustomLabelSpan;
import com.mx.engine.widget.simplifyspan.other.CustomLinkMovementMethod;
import com.mx.engine.widget.simplifyspan.other.OnClickableSpanListener;
import com.mx.engine.widget.simplifyspan.unit.BaseSpecialUnit;
import com.mx.engine.widget.simplifyspan.unit.SpecialImageUnit;
import com.mx.engine.widget.simplifyspan.unit.SpecialLabelUnit;
import com.mx.engine.widget.simplifyspan.unit.SpecialRawSpanUnit;
import com.mx.engine.widget.simplifyspan.unit.SpecialTextUnit;
                ...
                for (int startPos : specialTextUnit.getStartPoss()) {
                    ...
                    if (null != onClickListener) {
                        ...
                        spannableStringBuilder.setSpan(new
                                CustomClickableSpan(specialTextUnit), startPos, startPos + specialTextLength, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    }
                }
