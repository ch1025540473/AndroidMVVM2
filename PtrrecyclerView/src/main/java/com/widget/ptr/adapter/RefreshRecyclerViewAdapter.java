/**
 * @(#) z.sye.space.refreshrecyclerview.adapter 2015/11/2;
 * <p/>
...
public class RefreshRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private RecyclerView.AdapterDataObserver mDataObserver = new RecyclerView.AdapterDataObserver() {
        ...
        public void onItemRangeChanged(int positionStart, int itemCount) {
            RefreshRecyclerViewAdapter.this.notifyItemRangeChanged(positionStart + getHeadersCount(), itemCount);
            super.onItemRangeChanged(positionStart, itemCount);
        }

        @Override
        public void onItemRangeInserted(int positionStart, int itemCount) {
            RefreshRecyclerViewAdapter.this.notifyItemRangeInserted(positionStart + getHeadersCount(), itemCount);
...
//            RefreshRecyclerViewAdapter.this.onItemRangeChanged(positionStart, itemCount, payload);
        ...
        public void onItemRangeRemoved(int positionStart, int itemCount) {
            RefreshRecyclerViewAdapter.this.notifyItemRangeRemoved(positionStart + getHeadersCount(), itemCount);
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            RefreshRecyclerViewAdapter.this.notifyItemRangeChanged(fromPosition + getHeadersCount(), toPosition + getHeadersCount() + itemCount);
