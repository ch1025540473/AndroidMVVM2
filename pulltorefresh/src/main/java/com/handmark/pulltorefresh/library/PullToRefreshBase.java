...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected PullToRefreshHeaderListener mPullToRefreshHeaderListener;

    public PullToRefreshHeaderListener getPullToRefreshHeaderListener() {
        ...
        switch (mCurrentMode) {
            ...
            case PULL_FROM_START:
                ...
                if (mPullToRefreshHeaderListener != null) {
                    mPullToRefreshHeaderListener.pullToRefresh();
                }
                break;
            default:
                // NO-OP
    ...
    protected void onReleaseToRefresh() {
        switch (mCurrentMode) {
            ...
            case PULL_FROM_START:
                ...
                if (mPullToRefreshHeaderListener != null) {
                    mPullToRefreshHeaderListener.releaseToRefresh();
                }
                break;
            default:
                // NO-OP
        ...
        if (newScrollValue != 0 && !isRefreshing()) {
            ...
            switch (mCurrentMode) {
                ...
                default:
                    ...
                    if (mPullToRefreshHeaderListener != null) {
                        mPullToRefreshHeaderListener.onPull(scale);
                    }
                    break;
            }
